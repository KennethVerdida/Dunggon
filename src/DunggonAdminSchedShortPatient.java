...
public class DunggonAdminSchedShortPatient extends javax.swing.JFrame {
    PatientInfoClass patient;
    PatientShortTreatmentSched sched;
    private boolean flag = true;
    private String DunggonID;
    
    public DunggonAdminSchedShortPatient() {
        initComponents();
    }
    public DunggonAdminSchedShortPatient(PatientInfoClass patient) {
        initComponents();
        this.patient = patient;
    }
    public DunggonAdminSchedShortPatient(PatientInfoClass patient, boolean flag, String DunggonID) {
        initComponents();
        this.patient = patient;
    ...
    private void ExMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_ExMouseClicked
        ...
        DunggonAdminPatientForm().setVisible(true);
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(DunggonAdminSchedShortPatient.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new DunggonAdminSchedShortPatient().setVisible(true);
            }
        });
    }
