...
public class DunggonAdminPatientForm extends javax.swing.JFrame {
    private boolean flag = true;
    private DefaultTableModel table;
    private int row;
    private String DunggonID;
    
    public DunggonAdminPatientForm() {
        initComponents();
     ...
     public DunggonAdminPatientForm(boolean flag,String DunggonID) {
        initComponents();
        ButtonGroup btng = new ButtonGroup();
        btng.add(rdMale);
        btng.add(rdFemale);
    ...
    private void initComponents() {
        ...
        getContentPane().add(btnBack, new org.netbeans.lib.awtextra.AbsoluteConstraints(650, 700, 79, -1));
    ...
    private void btnShortSchedActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnShortSchedActionPerformed
        ...
        if(patient.getFname().trim().isEmpty() && patient.getMname().trim().isEmpty() && patient.getLname().trim().isEmpty() && patient.getContactNum1().trim().isEmpty()
            ...
            this.setVisible(false);
            if(flag){
                new DunggonAdminSchedShortPatient(patient).setVisible(true);
            }else{
                new DunggonAdminSchedShortPatient(patient,flag,DunggonID).setVisible(true);
    ...
    private void btnLongSchedActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnLongSchedActionPerformed
        ...
        if(patient.getFname().trim().isEmpty() && patient.getMname().trim().isEmpty() && patient.getLname().trim().isEmpty() && patient.getContactNum1().trim().isEmpty()
            ...
            this.setVisible(false);
            if(flag){
                new DunggonAdminSchedLongPatient(patient).setVisible(true);
            }else{
                new DunggonAdminSchedLongPatient(patient,flag,DunggonID).setVisible(true);
            }
        }
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(DunggonAdminPatientForm.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
