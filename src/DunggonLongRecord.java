...
public class DunggonLongRecord extends javax.swing.JFrame {
    private String DunggonID; 
    PatientInfoClass patient;
    PatientLongTreatmentSched sched;
    private boolean flag = true;
    
    public DunggonLongRecord() {
        initComponents();
        DefaultTableModel table = (DefaultTableModel)jtLongRec.getModel();
        ...
        tfStart.setText(table.getValueAt(0,17).toString());
        tfEnd.setText(table.getValueAt(0,18).toString());
    }
    
    public DunggonLongRecord(boolean flag,String DunggonID) {
        initComponents();
        this.flag = flag;
    ...
    private void initComponents() {
        ...
        jtLongRec = new javax.swing.JTable();
        ...
        jtLongRec.setModel(new javax.swing.table.DefaultTableModel(
            new Object [][] {
            ...
            new String [] {
                "ID", "First Name", "Middle Name", "Last Name", "Age", "Birthday", "Gender", "Status", "Occupation", "Contact No.", "Email", "Address", "Metal condition", "Previous Hospital", "Guardian", "Contact No.", "Email", "Start", "End"
            }
        ) {
        ...
        jtLongRec.getTableHeader().setReorderingAllowed(false);
        jScrollPane2.setViewportView(jtLongRec);
        ...
        getContentPane().add(btnSubmit, new org.netbeans.lib.awtextra.AbsoluteConstraints(1000, 560, -1, -1));
        ...
        getContentPane().add(btnEdit, new org.netbeans.lib.awtextra.AbsoluteConstraints(840, 560, 75, -1));
        ...
        getContentPane().add(btnDelete, new org.netbeans.lib.awtextra.AbsoluteConstraints(920, 560, 75, -1));
        ...
        getContentPane().add(Min, new org.netbeans.lib.awtextra.AbsoluteConstraints(1080, 0, -1, 30));
        ...
        getContentPane().add(Ex, new org.netbeans.lib.awtextra.AbsoluteConstraints(1110, 0, 30, 30));
        ...
        lblAge.setText("Age");
        getContentPane().add(lblAge, new org.netbeans.lib.awtextra.AbsoluteConstraints(90, 340, -1, 20));
        ...
        getContentPane().add(lblBirthday, new org.netbeans.lib.awtextra.AbsoluteConstraints(90, 370, -1, 20));
        ...
        getContentPane().add(lblGender, new org.netbeans.lib.awtextra.AbsoluteConstraints(90, 400, 50, 20));

        lblStatus.setText("Status");
        getContentPane().add(lblStatus, new org.netbeans.lib.awtextra.AbsoluteConstraints(90, 430, -1, 20));
        ...
        getContentPane().add(lblEmail, new org.netbeans.lib.awtextra.AbsoluteConstraints(90, 460, 100, 20));

        lblContactNumber1.setText("Contact Number");
        getContentPane().add(lblContactNumber1, new org.netbeans.lib.awtextra.AbsoluteConstraints(90, 490, 100, 22));
        ...
        getContentPane().add(lblFname, new org.netbeans.lib.awtextra.AbsoluteConstraints(90, 250, -1, -1));
        ...
        getContentPane().add(lblMname, new org.netbeans.lib.awtextra.AbsoluteConstraints(90, 280, -1, -1));
        ...
        getContentPane().add(lblLname, new org.netbeans.lib.awtextra.AbsoluteConstraints(90, 310, -1, -1));
        ...
        getContentPane().add(lblStart, new org.netbeans.lib.awtextra.AbsoluteConstraints(590, 450, 90, 20));

        lblEnd.setText("End Session");
        getContentPane().add(lblEnd, new org.netbeans.lib.awtextra.AbsoluteConstraints(590, 480, 90, 20));

        tfStart.addKeyListener(new java.awt.event.KeyAdapter() {
            public void keyPressed(java.awt.event.KeyEvent evt) {
                tfStartKeyPressed(evt);
            }
        });
        getContentPane().add(tfStart, new org.netbeans.lib.awtextra.AbsoluteConstraints(700, 450, 250, -1));

        tfEnd.addKeyListener(new java.awt.event.KeyAdapter() {
            public void keyPressed(java.awt.event.KeyEvent evt) {
                tfEndKeyPressed(evt);
            }
        });
        getContentPane().add(tfEnd, new org.netbeans.lib.awtextra.AbsoluteConstraints(700, 480, 250, -1));
    ...
    private void tfStartKeyPressed(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_tfStartKeyPressed
        if(evt.getKeyCode()==KeyEvent.VK_ENTER){
            DefaultTableModel table = (DefaultTableModel)jtLongRec.getModel();
            DunggonID = table.getValueAt(0,0).toString();
            boolean flag = false;
    ...
    }//GEN-LAST:event_tfStartKeyPressed

    private void tfEndKeyPressed(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_tfEndKeyPressed
       if(evt.getKeyCode()==KeyEvent.VK_ENTER){
            DefaultTableModel table = (DefaultTableModel)jtLongRec.getModel();
            DunggonID = table.getValueAt(0,0).toString();
            boolean flag = false;
    ...
    }//GEN-LAST:event_tfEndKeyPressed
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(DunggonLongRecord.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
    ...
    private javax.swing.JTable jtLongRec;
