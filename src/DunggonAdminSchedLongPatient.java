...
public class DunggonAdminSchedLongPatient extends javax.swing.JFrame {
    PatientInfoClass patient;
    PatientLongTreatmentSched sched;
    private boolean flag = true;
    private String DunggonID;

    public DunggonAdminSchedLongPatient() {
        initComponents();
    }
    
    public DunggonAdminSchedLongPatient(PatientInfoClass patient) {
        initComponents();
        this.patient = patient;
    }
    
    public DunggonAdminSchedLongPatient(PatientInfoClass patient, boolean flag, String DunggonID) {
        initComponents();
        this.patient = patient;
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(DunggonAdminSchedLongPatient.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new DunggonAdminSchedLongPatient().setVisible(true);
            }
        });
    }
